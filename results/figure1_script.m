...
anexo1_ideal = indicador_sintetico_anexo_1(:,3);

load('indicador_sintetico_anexo_1_estimado.mat')

anexo1_real = indicador_sintetico_anexo_1_estimado(:,3);
...
lg.FontSize = 18;
title('Benchmark Indicator','Units', 'normalized', 'Position', [0.5, -0.1, 0],'FontSize',18);
nexttile
mapshow(S);
...
title('Synthetic Indicator','Units', 'normalized', 'Position', [0.5, -0.1, 0],'FontSize',18);
