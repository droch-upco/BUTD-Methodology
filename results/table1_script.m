...
anexo1_ideal = squeeze(indicador_sintetico_anexo_1);
anexo1_real = indicador_sintetico_anexo_1_estimado{t,1}(:,1:3);
...
lista_indicadores_FILTRADA2 = [lista_indicadores_FILTRADA2; [ {[]} {'DP_80_20'}];
    [ {[]} {'GINI'}]];
...
for i =1:size(Indicators,1)
    index = find(strcmp(lista_indicadores_FILTRADA2(:,2), Indicators{i}));
    index = index(1,1);
...
summary_2017_means.Properties.RowNames = [{'Decile 10'} {'Decile 9'} ...
    {'Decile 8'} {'Decile 7'} {'Decile 6'} {'Decile 5'} {'Decile 4'} ...
    {'Decile 3'} {'Decile 2'} {'Decile 1'} {'Total'}];
clearvars -except summary_2015_means summary_2016_means summary_2017_means
